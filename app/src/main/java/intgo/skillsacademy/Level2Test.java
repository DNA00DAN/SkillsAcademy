...
public class Level2Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_2_test);
    ...
    private void saveQuestionResult() {
        ...
        if (questionNr <= 5) {
            if (answer.equals("")) {
                Toast.makeText(Level2Test.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                return;
            } else {
    ...
    private void saveResult() {
        if (questionNr == 5) {
            ...
            Toast.makeText(Level2Test.this, "Test has been completed", Toast.LENGTH_LONG).show();
            questionNr = 1;
            initializeArrays();
            ...
            public void onClick(View v) {
                ...
                if (Number.length() == 0 || Password.length() == 0) {
                    ...
                    if (Password.equals(supervisorLocalStore.getPassword()) && userType.equals("Supervisor")) {
                        ...
                        login.dismiss();
                        finish();
                        Intent i = new Intent(getApplicationContext(), Level2Test.class);
